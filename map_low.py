...
def calculate(city_name,year):
    ...
    temp = data[data['year'] == year]['最低气温'].tolist()
    min = 50
...
if __name__ == "__main__":
    ...
    for year in range(2011,2021):
        ...
        map0 = (
            ...
            .set_global_opts(
                title_opts=opts.TitleOpts(title=f"江苏地区{year}年低温分布图"), visualmap_opts=opts.VisualMapOpts(min_=-10,max_=5)
    ))
        timeline.add(map0,f"{year}年")
    timeline.render("江苏地区2011-2020年低温分布轮播图.html")